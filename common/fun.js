...
function log() {
    ...
    // prepend the date
    arguments[0] = String(((Date.now()-t0_game)*0.001).toFixed(1)) + ':' + String(arguments[0]);
...
// Returns a number fading from 1 to 0 from time t0 over the specified duration
// This one is linear at first and ends quadratically.
...
// Rotate a vector in PIXI coordinates
